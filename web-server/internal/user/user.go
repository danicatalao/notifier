...
type AppUser struct {
	...
	PhoneNumber sql.NullString `json:"phone_number,omitempty" db:"phone_number" validate:"omitempty,max=15"`
	Webhook     sql.NullString `json:"webhook,omitempty" db:"webhook"`
	Active      bool           `json:"active" db:"active"`
	OptOutDate  sql.NullTime   `json:"opt_out_date,omitempty" db:"opt_out_date"`
